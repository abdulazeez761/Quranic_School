...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Class>().HasMany(c => c.StudentAttendances).WithOne(sa => sa.Class)
            .OnDelete(DeleteBehavior.Cascade);
        modelBuilder.Entity<Class>().HasMany(c => c.TeacherAttendance).WithOne(sa => sa.Class)
            .OnDelete(DeleteBehavior.Cascade);
    }
}